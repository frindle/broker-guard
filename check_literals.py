...
LITERALS = [[None, 'PRESENCE_DB_PATH = "data/presence.sqlite3"'], [None, 'import broker_guard.state'], [None, '@app.get("/brokers", response_class=HTMLResponse)'], [None, 'def brokers():'], [None, 'broker_guard.state.init_db(PRESENCE_DB_PATH)'], [None, 'webui_data.query_presence_history(conn)']]
