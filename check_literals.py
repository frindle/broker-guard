...
TARGET = pathlib.Path('broker_guard/webui_data.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'def query_presence_history(conn: sqlite3.Connection, broker_id: str | None = None, limit: int = 200) -> list[dict]:'], [None, 'ORDER BY last_seen DESC'], [None, '"identity_key"']]
