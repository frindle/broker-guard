...
OPTOUT_OUT_OF_SCOPE = {
    ...
    "instantcheckmate-com": (
        "Verified 2026-09-23. The dataset's /privacy-center/ redirects to "
        "app.instantcheckmate.com/privacy-center/, which splits into 'User "
        "Data Tools' (cookie/advertising preferences, a Right-to-Know "
        "email) and 'Public Data Tools' -- and the public-data removal is "
        "a link off-site to https://suppression.peopleconnect.us/?brand="
        "InstantCheckmate, the PeopleConnect Suppression Center.\n"
        "\n"
        "That off-site hop is NOT the affiliate-front finding that sends "
        "publicrecordsnow-com and peoplefinder-com to NO_OPTOUT_SURFACE: "
        "PeopleConnect is this broker's own parent, and the page states "
        "its scope in its own words -- it suppresses the Background Report "
        "'on all people search sites in the PeopleConnect family including "
        "TruthFinder.com, InstantCheckmate.com, Intelius.com and "
        "USSearch.com' -- so a request filed there is filed for this "
        "broker, not for somebody else. It is also free, and says so.\n"
        "\n"
        "What puts it out of scope is the shape, the same emailed-link "
        "gate as truepeoplesearch-com and usphonebook-com: 'Step 1 Enter "
        "your email address. Upon submission of your email address you "
        "will receive a verification email with a link to proceed.' The "
        "one field on the page is an email box, beside a required 'I agree "
        "to the Terms of Use and Privacy Policy' checkbox; the form that "
        "actually names a person lives behind the mailed link, at a URL "
        "that does not exist yet. Nothing was submitted and the consent "
        "box was not ticked."
    ),
    "mylife-com": (
    ...
    "searchpeoplefree-com": (
        "Verified 2026-09-23: the emailed-link gate again, a third time, "
        "and with a third bot check. /opt-out ('Free People Search Opt Out "
        "/ Record Removal Request') carries a form with o_first, o_middle, "
        "o_last, o_email, an o_terms checkbox, a Cloudflare Turnstile "
        "response field and button#o_submit -- and the same four numbered "
        "directions, word for word, as truepeoplesearch-com and "
        "usphonebook-com: 'We will send a link to your email address that "
        "will take you to the opt-out form', expiring after 24 hours, with "
        "the record details entered only on that later page. Read off this "
        "site's own page, not inherited: the field names here (o_*) match "
        "neither sibling's, and the bot check is Turnstile where the other "
        "two use hCaptcha and reCAPTCHA respectively. Out of scope for the "
